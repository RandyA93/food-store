                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_image">
                                            <div class="image_frame image_item no_link scale-with-grid no_border">
                                                <div class="image_wrapper"><img class="scale-with-grid" src="<?php echo URLROOT; ?>/images/<?php echo $employee->first_name;?><?php echo $employee->last_name;?>.jpg" alt="<?php echo $employee->first_name;?><?php echo $employee->last_name;?>.jpg" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column mcb-column five-sixth column_column">
                                            <div class="column_attr clearfix">
                                                ...
                                                <?php echo $employee->first_name; ?> <?php echo $employee->last_name; ?></h4>
                                                <p class="themecolor">
